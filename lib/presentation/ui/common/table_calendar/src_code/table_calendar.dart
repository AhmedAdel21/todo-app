...
class TableCalendar<T> extends StatefulWidget {
  ...
  final TodoTaskIcon Function(DateTime day) getDayIcon;
...
class _TableCalendarState<T> extends State<TableCalendar<T>> {
      ...
      children: [
        ...
        Flexible(
          ...
          child: TableCalendarBase(
            ...
            customDoLaBuilder: (context, day, focusedMonth) {
              final weekdayString = widget.daysOfWeekStyle.dowTextFormatter
                      ?.call(day, widget.locale) ??
                  DateFormat.E(widget.locale).format(day);
  ...
  Widget _buildCell(DateTime day, DateTime focusedDay,
      [String? weekdayString, TextStyle? weekdayStringStyle]) {
          ...
          if (isSelected) {
            decoration = const BoxDecoration(
              ...
              gradient: LinearGradient(
                ...
                colors: [
                  // Colors.white,
                  Color.fromRGBO(32, 119, 233, 1),
                  Color.fromRGBO(46, 117, 210, 1),
                  Color.fromRGBO(124, 252, 252, 1),
                ],
              ),
            );
            weekdayStringStyle = getRegularStyle(
              fontSize: FontSizeConstants.s12,
              fontFamily: AppFontFamily.lato,
              color: ColorConstants.white,
            );
          }
          Widget selectedDayIcon = const SizedBox.shrink();
          final icon = widget.getDayIcon(day);
          if (icon != TodoTaskIcon.none) {
            selectedDayIcon = TodoTaskCardIconDot(widget.getDayIcon(day));
          }
