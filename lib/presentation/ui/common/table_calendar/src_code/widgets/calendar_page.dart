...
class CalendarPage extends StatelessWidget {
  ...
  final Widget Function(BuildContext context, DateTime day)? customDoLaBuilder;
  ...
  TableRow _buildCustomDays(BuildContext context) {
    return TableRow(
      decoration: dowDecoration,
      children: List.generate(
        7,
        (index) => customDoLaBuilder!(context, visibleDays[index]),
      ).toList(),
    );
  }
